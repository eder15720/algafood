...
insert into tab_restaurante (nome, taxa_frete, cozinha_id) values ('tudo nosso', 156, 2);
insert into tab_restaurante (nome, taxa_frete, cozinha_id) values ('nada consta', 200);

...
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values ('tudo nosso', 156, 2, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values ('nada consta', 200, 1, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values ('sete a um', 300, 1, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_complemento, endereco_cep, endereco_numero, endereco_logradouro, data_cadastro, data_atualizacao) 
values ('Frans Leste', 200, 1, 1, 'parque sírio', '03562523', '362', 'Rua Jose maturatto', utc_timestamp, utc_timestamp);
